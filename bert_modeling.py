# -*- coding: utf-8 -*-
"""
Created on Sat Aug 15 09:35:46 2020
...
def get_bert_model(input_word_ids,
  ...
  bert_model = tf.keras.Model(
      ...
      outputs=[pooled_output, sequence_output], name = 'bert-baseline')
  return bert_model
...
class BertModel(tf.keras.layers.Layer):
  ...
  def build(self, unused_input_shapes):
    ...
    print("EMBLOOKUP",self.embedding_lookup.trainable)
    ...
    print("EMBPROC",self.embedding_postprocessor.trainable)
    self.encoder = Transformer(
        ...
        trainable = False,
        name="encoder")
    print("ENC", self.encoder.trainable)
